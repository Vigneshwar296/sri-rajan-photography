...
export const metadata = {
  title: 'Wedding Photographer in Krishnagiri | Sri Rajan Photography',
  description:
    'Looking for a wedding photographer in Krishnagiri? Sri Rajan Photography offers candid wedding photography, cinematic wedding films, pre-wedding shoots and premium albums across Krishnagiri and Tamil Nadu.',
  alternates: {
    canonical: '/wedding-photographer-krishnagiri',
  },
  openGraph: {
    title: 'Wedding Photographer in Krishnagiri | Sri Rajan Photography',
    description:
      'Candid wedding photography and cinematic wedding films in Krishnagiri by Sri Rajan Photography.',
    url: '/wedding-photographer-krishnagiri',
    type: 'website',
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: 'Wedding photography in Krishnagiri by Sri Rajan Photography',
      },
    ],
  },
};
...
const schema = {
  ...
  '@type': 'Service',
  name: 'Wedding Photography in Krishnagiri',
  provider: {
...
export default function KrishnagiriWeddingPhotographyPage() {
  return (
    <main className="location-page">
      ...
      <section className="location-hero">
        <img
          ...
          alt="Wedding photographer in Krishnagiri"
        ...
        <div className="location-hero-content">
          ...
          <div className="location-hero-actions">
            ...
            <a
              href="https://wa.me/917010701473?text=Hello%20Sri%20Rajan%20Photography%2C%20I%20would%20like%20to%20enquire%20about%20wedding%20photography%20in%20Krishnagiri."
              target="_blank"
              rel="noreferrer"
      ...
      <section className="location-intro">
        ...
        <div className="location-intro-copy">
          <p>
            From intimate ceremonies to vibrant wedding celebrations, Sri Rajan Photography creates timeless visual stories across Krishnagiri. Our approach combines candid observation with elegant portraiture, allowing your photographs and films to reflect the people, emotions and atmosphere that made your celebration unique.
          </p>
