...
export const metadata = {
  title: 'Wedding Photographer in Vellore | Sri Rajan Photography',
  description:
    'Looking for a wedding photographer in Vellore? Sri Rajan Photography offers candid wedding photography, cinematic wedding films, pre-wedding shoots and premium albums across Vellore and Tamil Nadu.',
  alternates: {
    canonical: '/wedding-photographer-vellore',
  },
  openGraph: {
    title: 'Wedding Photographer in Vellore | Sri Rajan Photography',
    description:
      'Candid wedding photography and cinematic wedding films in Vellore by Sri Rajan Photography.',
    url: '/wedding-photographer-vellore',
    type: 'website',
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: 'Wedding photography in Vellore by Sri Rajan Photography',
      },
    ],
  },
};
...
const schema = {
  ...
  '@type': 'Service',
  name: 'Wedding Photography in Vellore',
  provider: {
...
export default function VelloreWeddingPhotographyPage() {
  return (
    <main className="location-page">
      ...
      <section className="location-hero">
        <img
          ...
          alt="Wedding photographer in Vellore"
        ...
        <div className="location-hero-content">
          ...
          <div className="location-hero-actions">
            ...
            <a
              href="https://wa.me/917010701473?text=Hello%20Sri%20Rajan%20Photography%2C%20I%20would%20like%20to%20enquire%20about%20wedding%20photography%20in%20Vellore."
              target="_blank"
              rel="noreferrer"
      ...
      <section className="location-intro">
        ...
        <div className="location-intro-copy">
          <p>
            Sri Rajan Photography captures weddings across Vellore through refined portraiture, candid moments and cinematic storytelling. Whether your celebration is rooted in tradition or designed with a contemporary touch, we focus on creating photographs that remain meaningful long after the wedding day.
          </p>
