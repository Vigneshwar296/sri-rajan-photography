...
export const metadata = {
  title: 'Wedding Photographer in Salem | Sri Rajan Photography',
  description:
    'Looking for a wedding photographer in Salem? Sri Rajan Photography offers candid wedding photography, cinematic wedding films, pre-wedding shoots and premium albums across Salem and Tamil Nadu.',
  alternates: {
    canonical: '/wedding-photographer-salem',
  },
  openGraph: {
    title: 'Wedding Photographer in Salem | Sri Rajan Photography',
    description:
      'Candid wedding photography and cinematic wedding films in Salem by Sri Rajan Photography.',
    url: '/wedding-photographer-salem',
    type: 'website',
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: 'Wedding photography in Salem by Sri Rajan Photography',
      },
    ],
  },
};
...
const schema = {
  ...
  '@type': 'Service',
  name: 'Wedding Photography in Salem',
  provider: {
...
export default function SalemWeddingPhotographyPage() {
  return (
    <main className="location-page">
      ...
      <section className="location-hero">
        <img
          ...
          alt="Wedding photographer in Salem"
        ...
        <div className="location-hero-content">
          ...
          <div className="location-hero-actions">
            ...
            <a
              href="https://wa.me/917010701473?text=Hello%20Sri%20Rajan%20Photography%2C%20I%20would%20like%20to%20enquire%20about%20wedding%20photography%20in%20Salem."
              target="_blank"
              rel="noreferrer"
      ...
      <section className="location-intro">
        ...
        <div className="location-intro-copy">
          <p>
            Sri Rajan Photography captures weddings across Salem with a focus
            on genuine emotions, meaningful details and natural storytelling.
            From traditional ceremonies to modern celebrations, every frame is
            created to feel personal, elegant and timeless.
          </p>
