...
export const metadata = {
  title: 'Wedding Photographer in Ambur | Sri Rajan Photography',
  description:
    'Looking for a wedding photographer in Ambur? Sri Rajan Photography offers candid wedding photography, cinematic wedding films, pre-wedding shoots and premium albums across Ambur and Tamil Nadu.',
  alternates: {
    canonical: '/wedding-photographer-ambur',
  },
  openGraph: {
    title: 'Wedding Photographer in Ambur | Sri Rajan Photography',
    description:
      'Candid wedding photography and cinematic wedding films in Ambur by Sri Rajan Photography.',
    url: '/wedding-photographer-ambur',
    type: 'website',
    images: [
      {
        ...
        width: 1536,
        height: 1024,
        alt: 'Wedding photography in Ambur by Sri Rajan Photography',
      },
    ],
  },
};
...
const schema = {
  ...
  '@type': 'Service',
  name: 'Wedding Photography in Ambur',
  provider: {
...
export default function AmburWeddingPhotographyPage() {
  return (
    <main className="location-page">
      ...
      <section className="location-hero">
        <img
          ...
          alt="Wedding photographer in Ambur"
        ...
        <div className="location-hero-content">
          ...
          <div className="location-hero-actions">
            ...
            <a
              href="https://wa.me/917010701473?text=Hello%20Sri%20Rajan%20Photography%2C%20I%20would%20like%20to%20enquire%20about%20wedding%20photography%20in%20Ambur."
              target="_blank"
              rel="noreferrer"
      ...
      <section className="location-intro">
        ...
        <div className="location-intro-copy">
          <p>
            Every wedding in Ambur carries its own traditions, personalities and moments worth preserving. Sri Rajan Photography documents those stories through natural candid photography, thoughtful portraits and cinematic films designed to bring the feeling of your celebration back for years to come.
          </p>
